metadata {
    definition (name: "My Keen Home Smart Vent v3", namespace: "jscgs350", author: "Keen Home") {
    ...
    tiles(scale: 2) {
        ...
        valueTile("ventTen", "device.level", width: 1, height: 1, inactiveLabel: false, decoration: "flat") {
            state "ventTen", label:'10%', action:"ventTen"
        }
        valueTile("ventTwenty", "device.level", width: 1, height: 1, inactiveLabel: false, decoration: "flat") {
            state "ventTwenty", label:'20%', action:"ventTwenty"
        }
        valueTile("ventThirty", "device.level", width: 1, height: 1, inactiveLabel: false, decoration: "flat") {
            state "ventThirty", label:'30%', action:"ventThirty"
        }
        valueTile("ventForty", "device.level", width: 1, height: 1, inactiveLabel: false, decoration: "flat") {
            state "ventForty", label:'40%', action:"ventForty"
        }
        ...
        valueTile("ventSixty", "device.level", width: 1, height: 1, inactiveLabel: false, decoration: "flat") {
            state "ventSixty", label:'60%', action:"ventSixty"
        }
        valueTile("ventSeventy", "device.level", width: 1, height: 1, inactiveLabel: false, decoration: "flat") {
            state "ventSeventy", label:'70%', action:"ventSeventy"
        }
        valueTile("ventEighty", "device.level", width: 1, height: 1, inactiveLabel: false, decoration: "flat") {
            state "ventEighty", label:'80%', action:"ventEighty"
        }
        valueTile("ventNinety", "device.level", width: 1, height: 1, inactiveLabel: false, decoration: "flat") {
            state "ventNinety", label:'90%', action:"ventNinety"
        }
